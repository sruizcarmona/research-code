...
then
        ...
        do
                ...
                then
                        ...
                        echo UNKNOWN OPTIONS, please use prep, marc or dock!
                        exit 1;
                fi;
        done;
fi;
...
then 
	...
	cp $SCRIPTS/files/vina_screen_local.sh $SCRIPTS/files/qsub_vina_tmp.sh vina
...
then
	#run docking!!!
	echo sh vina/vina_screen_local.sh
fi;
